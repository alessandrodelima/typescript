...
//É uma estrutura que você definine valores pré-definidos. ex: Dias da semana

enum Cor {
    Cinza,  // 0
    Verde = 100,  // 1 agora não é mais 1 é 100. Atribui um valor.
    Azul = 2,   // 2
    Laranja,
    Amarelo, 
    Vermelho = 100
...
let funcionario2: Funcionario = {
    ...
    baterPonto(horario: number): string {
        if(horario <= 8) {
            return "Ponto normal funcionario 2"
        }else {
            return "Fora do horário! funcionario 2"
        }
    }
} 
...
console.log(`Minha note é ${nota} !`); //Back stick
nota = "10"; 
console.log(`Minha note é ${nota} !`); //Back stick
// nota = true;
